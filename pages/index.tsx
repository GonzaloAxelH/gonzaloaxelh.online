...
export default function Home({ articles, allTags }: any) {
  return (
                          ...
                          <div className="vc_column-inner">
                            <div className="wpb_wrapper">
                              ...
                              <div
                                ...
                                id="ohio-custom-63d7a7d3c5c4b"
                              >
                                <div className="subtitle">Secciones </div>
                                <h3 className="title">
                                  Cosas que puedes hacer aqui
                                </h3>
                              </div>
                              <div
                        ...
                        <div className="wpb_column vc_column_container vc_col-sm-6 vc_col-xs-6">
                          <div className="vc_column-inner">
                            <div className="wpb_wrapper">
                              ...
                              >
                                <h4 className="title">Mis applicaciones</h4>
                              </div>
                            </div>
                          </div>
                        </div>
