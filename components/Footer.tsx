          ...
          <div className="vc_col-md-3 vc_col-sm-6 widgets-column">
            <ul>
              ...
              <li
                ...
                className="widget_text widget widget_custom_html"
              >
                <h3 className="title widget-title">Barcelona</h3>
                <div className="textwidget custom-html-widget">
                              ...
                              <span className="wpcf7-list-item first last">
                                <label>
                                  <input
                                    type="checkbox"
                                    name="checkbox-101[]"
                                    defaultValue="I’m okay with getting emails and having that activity tracked to improve my experience."
                                    tabIndex={2}
                                  />
